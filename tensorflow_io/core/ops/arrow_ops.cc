...
REGISTER_OP("IO>ArrowV4Dataset")
    .Input("aws_access_key: string")
    .Input("aws_secret_key: string")
    .Input("aws_endpoint_override: string")
    .Input("small_table_files: string")
    .Input("big_table_files: string")
    .Input("column_names: string")
    .Input("filter: string")
    .Input("columns: int32")
    .Input("batch_size: int64")
...
aws_secret_key: S3 secret_key.
aws_endpoint_override: S3 endpoint override
small_table_files: One or more parqeut file path on s3
big_table_files: One or more parquet file path on s3
column_names: Select columns to read by names
)doc");
